            ...
            for line in block["lines"]:
                for span in line["spans"]:
                    if (
                        ...
                        session += span["text"]
                    elif span["size"] == 9 and span["font"] == "TimesNewRomanPS-BoldMT":
                        title += span["text"]
                    elif span["font"] == "TimesNewRomanPS-ItalicMT":
                        if span["size"] == 9:
                            authors.append(span["text"])
                        elif span["size"] == 8:
                            affiliations.append(span["text"])
                    elif span["size"] == 9.134002685546875:
                        abstract += span["text"]
